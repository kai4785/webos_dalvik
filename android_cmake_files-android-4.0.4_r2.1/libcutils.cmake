...
#        uio.c
    ...
    concat(commonHostSources
        tzstrftime.c
        )
#endif


# Building the static host one for the target
# Static library for host
# ========================================================
set(LOCAL_MODULE cutils)
set(LOCAL_SRC_FILES ${commonSources} ${commonHostSources} ${CMAKE_SOURCE_DIR}/dlmalloc_stubs.c)
set(LOCAL_LDLIBS -lpthread)
set(LOCAL_STATIC_LIBRARIES log)
#concat(LOCAL_CFLAGS ${hostSmpFlag})
#well almost

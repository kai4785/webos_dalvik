...
if(${ARCH_ARM_HAVE_VFP})
    concat(LOCAL_CFLAGS -DANDROID_LARGE_MEMORY_DEVICE)
endif()

if(${ARCH_ARM_HAVE_VFP})
	concat(LOCAL_CFLAGS -DSK_SOFTWARE_FLOAT)
endif()

if(${ARCH_ARM_HAVE_NEON})
	concat(LOCAL_CFLAGS -D__ARM_HAVE_NEON)
endif()
...
#FIXME: 
#/home/kai/workspace/webos_dalvik/external/skia/src/opts/SkBlitRow_opts_arm.cpp: In function ‘void S32A_Blend_BlitRow32_arm(SkPMColor*, const SkPMColor*, int, U8CPU)’:
#/home/kai/workspace/webos_dalvik/external/skia/src/opts/SkBlitRow_opts_arm.cpp:789: error: fp cannot be used in asm here

...
static webOSRuntime* gCurRuntime = NULL;
...
/*static*/ JavaVM* webOSRuntime::mJavaVM = NULL;


webOSRuntime::webOSRuntime()
{
    //SkGraphics::Init();
 ...
 */
/*static*/ int webOSRuntime::registerNativeMethods(JNIEnv* env,
    const char* className, const JNINativeMethod* gMethods, int numMethods)
{
    return jniRegisterNativeMethods(env, className, gMethods, numMethods);
}

status_t webOSRuntime::callMain(const char* className,
 ...
 */
int webOSRuntime::addVmArguments(int argc, const char* const argv[])
{
    int i;
 ...
 */
void webOSRuntime::parseExtraOpts(char* extraOptsBuf)
{
    JavaVMOption opt;
    char* start;
    char* end;
 ...
 */
int webOSRuntime::startVm(JavaVM** pJavaVM, JNIEnv** pEnv)
{
    int result = -1;
...
char* webOSRuntime::toSlashClassName(const char* className)
{
 ...
 * options string.
 */
void webOSRuntime::start(const char* className, const char* options)
{
    LOGD("\n>>>>>> webOSRuntime START %s <<<<<<\n",
...
void webOSRuntime::onExit(int code)
{
    LOGV("webOSRuntime onExit calling exit(%d)", code);
    exit(code);
}

void webOSRuntime::onVmCreated(JNIEnv* env)
{
    // If webOSRuntime had anything to do here, we'd have done it in 'start'.
}
 ...
 */
/*static*/ JNIEnv* webOSRuntime::getJNIEnv()
{
    JNIEnv* env;
    JavaVM* vm = webOSRuntime::getJavaVM();
    assert(vm != NULL);
 ...
 */
/*static*/ int webOSRuntime::javaThreadShell(void* args) {
 ...
 */
/*static*/ int webOSRuntime::javaCreateThreadEtc(
                                ...
                                android_thread_id_t* threadId)
{
    ...
    result = androidCreateRawThreadEtc(webOSRuntime::javaThreadShell, args,
 ...
 */
/*static*/ android_thread_id_t webOSRuntime::createJavaThread(const char* name,
 ...
 */
/*static*/ int webOSRuntime::startReg(JNIEnv* env)
{
    /*
...
webOSRuntime* webOSRuntime::getRuntime()
{
    return gCurRuntime;
}

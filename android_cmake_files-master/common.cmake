...
concat(src_files ../stubdata/stubdata.c)
...
concat(local_cflags -DU_TIMEZONE=timezone)

concat(local_cflags -D_REENTRANT -DU_COMMON_IMPLEMENTATION)

concat(local_cflags -O3 -fvisibility=hidden)
set(local_ldlibs -ldl -lm -lpthread)

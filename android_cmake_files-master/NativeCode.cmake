...
concat(LOCAL_CPPFLAGS ${core_cppflags})
if(${TARGET_ARCH} STREQUAL arm)
    # Ignore "note: the mangling of 'va_list' has changed in GCC 4.4"
    #This breaks the GCC from the PDK
...
set(LOCAL_SHARED_LIBRARIES ${core_shared_libraries} expat icuuc icui18n ssl crypto libz nativehelper)
